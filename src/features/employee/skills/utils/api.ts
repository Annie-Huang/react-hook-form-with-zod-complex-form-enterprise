...
export const getCoreCompetencies = async (): Promise<AutocompleteOption[]> => {
  await wait();
...
export const getProficiencyLevels = async (): Promise<AutocompleteOption[]> => {
  await wait();
...
export const getSkillCategories = async (): Promise<AutocompleteOption[]> => {
  await wait();
...
export const getSkillSubcategories = async (
  categoryId: string,
...
export const getLanguages = async (): Promise<AutocompleteOption[]> => {
  await wait();
  return [
